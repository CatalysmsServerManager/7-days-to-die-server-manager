module.exports = {
  ...
  fn: async function (inputs, exits) {
    ...
    sails.log.info(`User #${this.req.session.user.id} ${this.req.session.username} has deleted a comment on ban #${deletedComment.ban}`, {deletedComment, user: this.req.session.user});
