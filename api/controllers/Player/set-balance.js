module.exports = {
  ...
  fn: async function (inputs, exits) {
    ...
    sails.log.info(`Set balance of player ${updatedPlayer[0].id} - ${updatedPlayer[0].name} to ${inputs.newBalance} on server ${updatedPlayer[0].server}`, {player: updatedPlayer[0], serverId: updatedPlayer[0].server});
